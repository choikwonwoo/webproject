...
public class MemberInfo {
	private String mi_mail, mi_nick, mi_pw, mi_name, mi_birth, mi_gender, mi_pimg, mi_iscouple , mi_status , mi_join , mi_last , ci_idx, mi_dding, ci_nick;
	...
	public String getMi_pimg() {
		return mi_pimg;
	}

	public void setMi_pimg(String mi_pimg) {
		this.mi_pimg = mi_pimg;
	}

	public String getMi_iscouple() {
		return mi_iscouple;
	}

	public void setMi_iscouple(String mi_iscouple) {
		this.mi_iscouple = mi_iscouple;
	}
	...
	public String getCi_nick() {
		return ci_nick;
	}

	public void setCi_nick(String ci_nick) {
		this.ci_nick = ci_nick;
	}
